<template>
  <section id="about">
    <h2  data-aos="fade-right" data-aos-delay="100" id="title-about"><span class="alt-i alt-user"></span>About</h2>
    <div class="box-about">
      <div class="info-about">
        ...
        <div class="box-symbols"  data-aos="fade-up" data-aos-delay="800">
          <div class="container-symbols">
            <div class="round"></div>
            <span class="alt-i alt-losange"></span>
          </div>
          <div class="container-symbols">
            <div class="square"></div>
            <span class="alt-i alt-cross"></span>
          </div>
        </div>
      </div>
    ...
    <div class="box-interests">
      ...
      <div class="icons-interests">
        <span class="alt-i alt-game-controller"  data-aos="fade-up" data-aos-delay="200"></span>
        <span class="alt-i alt-coffee"  data-aos="fade-up" data-aos-delay="400"></span>
        <span class="alt-i alt-web-development"  data-aos="fade-up" data-aos-delay="600"></span>
        <span class="alt-i alt-japan"  data-aos="fade-up" data-aos-delay="800"></span>
        <span class="alt-i alt-cat"  data-aos="fade-up" data-aos-delay="1000"></span>
      </div>
    </div>
  </section>
</template>
